...
EN = {
    ...
    "Do kosza: {v0} plików • {v1}  |  Pewne duplikaty: {v2} • {v3}": "Selected: {v0} files • {v1}  |  Exact duplicates: {v2} • {v3}",
    "Smart Keep • kopie są identyczne bajt w bajt — zachowaj dowolną.": "Smart Keep • copies are byte-identical — keep either one.",
    "Smart Keep • sugerowane zachowanie: {v0} • wynik {v1}/100 • pewność: {v2}": "Smart Keep • suggested keeper: {v0} • score {v1}/100 • confidence: {v2}",
    "wysoka": "high", "średnia": "medium", "niska": "low",
    "Folder Health • zdjęcia: {v0} • dokładne duplikaty: {v1} • podobne do przeglądu: {v2} • pewne oszczędności: {v3} • uwagi: {v4}": "Folder Health • photos: {v0} • exact duplicates: {v1} • similar for review: {v2} • exact savings: {v3} • notices: {v4}",
    "\n… i {v0} kolejnych": "\n… and {v0} more",
